...
def calculate_dimensions_from_input(width, height, base=32):
    new_width = round(width / base) * base
    new_height = round(height / base) * base
...
class VanillaPipeline(QwenImageEditPlusPipeline):
    ...
    def __call__(
        ...
        calculated_width, calculated_height = calculate_dimensions_from_input(image.size[0],image.size[1])
